...
void ssd1306_hline(ssd1306_t *ssd, uint8_t x0, uint8_t x1,
                   uint8_t y, bool value);
void ssd1306_vline(ssd1306_t *ssd, uint8_t x, uint8_t y0,
                   uint8_t y1, bool value);
void ssd1306_draw_small_number(ssd1306_t *ssd, char c,
                                uint8_t x, uint8_t y);
void ssd1306_draw_char(ssd1306_t *ssd, char c, uint8_t x,
                       uint8_t y, bool use_small_numbers);
void ssd1306_draw_string(ssd1306_t *ssd, const char *str,
                         uint8_t x, uint8_t y, bool use_small_numbers);
